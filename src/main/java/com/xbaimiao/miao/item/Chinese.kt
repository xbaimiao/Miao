...
object Chinese {
	...
	enum class Data(private val str: String) {
		...
		POLISHED_BLACKSTONE_BRICKS_SLAB("磨制黑石砖台阶"),
		POLISHED_BLACKSTONE_BRICKS_STAIRS("磨制黑石砖楼梯"),
		...
		BROWN_BED("褐色床"),
		BROWN_CARPET("褐色地毯"),
		BROWN_CONCRETE("褐色混凝土"),
		BROWN_CONCRETE_POWDER("褐色混凝土粉"),
		BROWN_DYE("棕色染料"),
		BROWN_GLAZED_TERRACOTTA("褐色带釉陶瓦"),
		BROWN_MUSHROOM("棕色蘑菇方块"),
		BROWN_MUSHROOM_BLOCK("棕色巨型蘑菇"),
		BROWN_SHULKER_BOX("褐色潜影盒"),
		...
		CHAINMAIL_COMMAND_BLOCK("连锁型命令方块"),
		CHARCOAL("木炭"),
		CHEST("箱子"),
		CHEST_MINECART("运输矿车"),
		CHICKEN("生鸡肉"),
		...
		CRAFTING_TABLE("工作台"),
		CREEPER_BANNER_PATTERN("旗帜图案(苦力怕盾徽)"),
		CREEPER_HEAD("苦力怕的头"),
		...
		FLINT("燧石"),
		FLINT_AND_STEEL("打火石"),
		FLOWER_BANNER_PATTERN("旗帜图案(花朵盾徽)"),
		FLOWER_POT("花盆"),
		FOX_SPAWN_EGG("狐狸刷怪蛋"),
		...
		JUNGLE_LOG("丛林原木"),
		JUNGLE_PLANKS("丛林木板"),
		JUNGLE_PRESSURE_PLATE("从林木压力板"),
		JUNGLE_SAPLING("丛林树苗"),
		JUNGLE_SIGN("丛林木告示牌"),
		JUNGLE_SLAB("丛林台阶"),
		JUNGLE_STAIRS("丛林楼梯"),
		JUNGLE_TRAPDOOR("丛林活板门"),
		...
		LIGHT_BLUE_CONCRETE_POWDER("淡蓝色混凝土粉"),
		...
		LIGHT_GRAY_CONCRETE_POWDER("淡灰色混凝土粉"),
		...
		LIME_CARPET("黄色地毯"),
		LIME_CONCRETE("黄色混凝土"),
		LIME_CONCRETE_POWDER("黄色混凝土粉"),
		LIME_DYE("黄绿色染料"),
		LIME_GLAZED_TERRACOTTA("黄色带釉陶瓦"),
		LIME_SHULKER_BOX("黄色潜影盒"),
		...
		MAGENTA_CONCRETE_POWDER("品红色混凝土粉"),
		MAGENTA_DYE("品红色染料"),
		...
		MILK_BUCKET("牛奶桶"),
		MINECART("矿车"),
		MOJANG_BANNER_PATTERN("旗帜图案(Mojang盾徽)"),
		...
		POLISHED_ANDESITE_SLAB("錾制安山岩台阶"),
		POLISHED_ANDESITE_STAIRS("錾制安山岩楼梯"),
		POLISHED_DIORITE("磨制闪长岩"),
		POLISHED_DIORITE_SLAB("錾制闪长岩台阶"),
		POLISHED_DIORITE_STAIRS("錾制闪长岩楼梯"),
		POLISHED_GRANITE("磨制花岗岩"),
		POLISHED_GRANITE_SLAB("錾制花岗岩台阶"),
		POLISHED_GRANITE_STAIRS("錾制花岗岩楼梯"),
		...
		RED_CARPET("红色地毯"),
		RED_CONCRETE("红色混凝土"),
		RED_CONCRETE_POWDER("红色混凝土粉"),
		RED_DYE("红色染料"),
		RED_GLAZED_TERRACOTTA("红色带釉陶瓦"),
		RED_MUSHROOM("红色蘑菇方块"),
		RED_MUSHROOM_BLOCK("红色巨型蘑菇"),
		RED_NETHER_BRICKS("红色地狱砖"),
		RED_NETHER_BRICK_SLAB("红色地狱砖台阶"),
		RED_NETHER_BRICK_STAIRS("红色地狱砖楼梯"),
		RED_NETHER_BRICK_WALL("红色地狱砖墙"),
		RED_SAND("红沙"),
		RED_SANDSTONE("红砂岩"),
		...
		SKULL_BANNER_PATTERN("旗帜图案(头颅盾徽)"),
		SLIME_BALL("粘液球"),
		SLIME_BLOCK("粘液块"),
		...
		SMOOTH_RED_SANDSTONE_STAIRS("平滑红砂岩台阶"),
		...
		WITHER_SKELETON_SPAWN_EGG("凋零骷髅刷怪蛋"),
